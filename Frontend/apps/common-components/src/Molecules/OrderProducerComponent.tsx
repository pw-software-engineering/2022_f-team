...
interface OrderProducerComponentProps {
  order: OrderProducerModel
...
const OrderProducerComponent = (props: OrderProducerComponentProps) => {
  return (
...
export default OrderProducerComponent
