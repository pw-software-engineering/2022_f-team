...
import { FiltersComponent, RangeFilter, RangeFilterOnChangeProps } from "../Molecules/AdvancedFilters";
...
const DietList = (props: DietListProps) => {
    ...
    const getParametersFromQuery = (query: GetDietsQuery) => {
        const parameters =
            ...
            addParameterIfDefined(query, "Offset") +
    ...
    const getCurrentlyShownEntries = () =>
        dietsList.slice(dietItemOffset(), maxItemsPerPage + dietItemOffset());
